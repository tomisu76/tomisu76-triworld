 ...
 * physical road cross-section. Triangle rasterization remains authoritative
 * for daylight slopes, but a nearest-segment capsule pass closes sub-cell and
 * sharp-bend holes that can otherwise expose original terrain beneath road
 * edges when sampled bilinearly by BeamNG.
 */
