/**
 * CLI Generator for TriWorld V4 Gate 2 — Ortofoto & Terrain Materials (Bánovce nad Bebravou)
 */
...
async function main() {
  console.log('Building TriWorld V4 Gate 2 Ortofoto & Real-World Terrain (Bánovce nad Bebravou)...');
  ...
  const levelFiles = generateLevelPackageFiles(artifact, {
    title: 'TriWorld V4 Native Gate 2 (Bánovce Ortofoto & Real-World Terrain)',
    description: 'Bánovce nad Bebravou high-resolution orthophoto satellite & terrain level',
  ...
  const gisManifest = {
    ...manifest,
    gate: 'Gate 2 — Ortofoto & Terrain Materials',
    gisLocation: 'Bánovce nad Bebravou, Slovakia',
    orthoTextureResolution: '1024x1024 px (1.0m/px spatial resolution)',
